...
describe('AVL tree', () => {
  describe('Sanity checks', () => {
    it('Checking that all nodes heights are correct', () => {
      ...
      (() => { avlt.checkHeightCorrect() }).should.throw()
      avlt.height = 1;
      (() => { avlt.checkHeightCorrect() }).should.throw()
      l.height = 1;
      (() => { avlt.checkHeightCorrect() }).should.throw()
    ...
    it('Can check that a tree is balanced', () => {
      ...
      r.height = 0;
      (() => { avlt.checkBalanceFactors() }).should.throw()
      r.height = 4;
      (() => { avlt.checkBalanceFactors() }).should.throw()
      r.height = 2
      avlt.checkBalanceFactors()
  ...
  describe('Deletion', () => {
    it('Deletion does nothing on an empty tree', () => {
      ...
      Object.prototype.hasOwnProperty.call(avlt.tree, 'key').should.equal(false)
      Object.prototype.hasOwnProperty.call(avltu.tree, 'key').should.equal(false)
